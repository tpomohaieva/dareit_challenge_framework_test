...
class TestDashboardPage(unittest.TestCase):
    ...
    def test_change_language(self): # ST06
        ...
        self.driver.save_screenshot("./screenshots/check_dashboard/before-lang-change.png")
        Image.open("./screenshots/check_dashboard/before-lang-change.png").show()
        ...
        self.driver.save_screenshot("./screenshots/check_dashboard/after-lang-change.png")
        Image.open("./screenshots/check_dashboard/after-lang-change.png").show()
