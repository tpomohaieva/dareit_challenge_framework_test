...
class TestLoginPage(unittest.TestCase):
    ...
    def test_log_in_to_the_system_with_valid_data(self): #ST01
        ...
        self.driver.save_screenshot("./screenshots/login_to_the_system/login-form-filled.png")
        Image.open("./screenshots/login_to_the_system/login-form-filled.png").show()
    ...
    def test_log_in_to_the_system_with_invalid_password(self): # ST02
        ...
        self.driver.save_screenshot("./screenshots/login_to_the_system/invalid-password.png")
        Image.open("./screenshots/login_to_the_system/invalid-password.png").show()
    ...
    def test_log_in_to_the_system_with_missing_login(self): # ST03
        ...
        self.driver.save_screenshot("./screenshots/login_to_the_system/missing-login.png")
        Image.open("./screenshots/login_to_the_system/missing-login.png").show()
    ...
    def test_remind_password_form(self): # ST04
        ...
        self.driver.save_screenshot("./screenshots/login_to_the_system/remind-pw.png")
        Image.open("./screenshots/login_to_the_system/remind-pw.png").show()
    ...
    def test_log_out_from_the_system(self):  # ST05
        ...
        dashboard_page = Dashboard(self.driver)
        dashboard_page.title_of_the_page()
        self.driver.save_screenshot("./screenshots/login_to_the_system/dashboard-page.png")
        Image.open("./screenshots/login_to_the_system/dashboard-page.png").show()
        dashboard_page.click_on_sign_out()
        user_login = LoginPage(self.driver)
        user_login.title_of_the_page()
        self.driver.save_screenshot("./screenshots/login_to_the_system/signed-out.png")
        Image.open("./screenshots/login_to_the_system/signed-out.png").show()
